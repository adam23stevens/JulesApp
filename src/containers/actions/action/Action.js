...
class Action extends Component {
    ...
    onCheckAnswer = (answer, guess) => {
        ...
        if (!isCorrect) {
            ...
            if (this.state.actionState.unlocks.voucher != undefined) {
                let voucherUnlock = this.state.actionState.unlocks.voucher;
            ...
            if (this.state.actionState.unlocks.present != undefined) {
                let presentUnlock = this.state.actionState.unlocks.present;
